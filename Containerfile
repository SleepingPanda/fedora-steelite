...
RUN dnf -y install /tmp/akmods-nvidia/kernel-rpms/*.rpm
RUN dnf -y install /tmp/akmods-nvidia/rpms/ublue-os/*.rpm
RUN dnf -y install /tmp/akmods-nvidia/rpms/kmods/*.rpm
